...
static constexpr wchar_t module_name[26] = {0x0051, 0x0075, 0x0069, 0x0063, 0x006B, 0x0041, 0x0063, 0x0074, 0x0069, 0x006F, 0x006E, 0x0073, 0x0044, 0x0061, 0x0074, 0x0061, 0x004D, 0x006F, 0x0064, 0x0065, 0x006C, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 1559253120U || rva >= image_size) return nullptr;
return base + rva;
}
