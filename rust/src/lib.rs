//! Windissect-generated Rust FFI bindings for QuickActionsDataModel.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "39C65FDDE5F2F3D8C93B142703FE2551";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 1559253120;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 26] = [81, 117, 105, 99, 107, 65, 99, 116, 105, 111, 110, 115, 68, 97, 116, 97, 77, 111, 100, 101, 108, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 1559253120 { return 0; }
